...
Public Class Delete_emp
    ...
    Private Sub Delete_emp_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        loadSetting(Me)
        LoadData()
    End Sub
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Connectdb()
        sqL = "delete from staff where staffid=" & Val(txtstaffid.Text)
        cmd = New OleDbCommand(sqL, conn)
        Dim i As Integer
